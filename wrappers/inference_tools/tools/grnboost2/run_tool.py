"""GRNBoost2 wrapper for the inference_tools execution contract.
...
def _resolve_params(
    ...
    required_keys = {"regressor_kwargs", "limit", "seed"}
    ...
    return regressor_kwargs, limit, seed
...
def main() -> None:
    ...
    try:
        ...
        regressor_kwargs, limit, seed = _resolve_params(raw_params)
