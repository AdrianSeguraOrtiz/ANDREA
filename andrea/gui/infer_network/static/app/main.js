    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "column native: ANDREA launches one Docker run on the full dataset; the image must write column:<column_id> contexts.",
          "group aggregated: the image writes column:<column_id> contexts and ANDREA aggregates them into group:<group_id> rows.",
        ],
      },
    ],
  }));
